...
class Deal:
    ...
    def calculate_delay_bonus(self): 
        ...
        additional_weeks = max(0, self.payment_delay_weeks - 2)
    ...
    def calculate_profit(self):
        ...
        pepper_value = self.pepper_deal.caculate_pepper_value()
    ...
    def create_streamlit_app():
        ...
        if st.button("Calculate Profitability"):
            ...
            with col1: 
                st.metric("Effective Buyer Rate", f"{results['effective_buyeer_rate']:.2f}%")
